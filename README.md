...
- **Success metrics**
Representatives are evaluated based on their resolution rate and query time. A successful LLM powered chatbot deployment would require equivalent or better performance as measured by these metrics as well as user engagement and error rates.
<br>

- **Key challenges in deploying chatbots**
